...
import { CustomImageOnly } from "@/components/Pages/worklife/blog/CustomImageOnly";
import { CustomImageHorizontal } from "@/components/Pages/worklife/blog/CustomImageHorizontal";
...
const AlternateGrid = ({ slice }: AlternateGridProps): JSX.Element => {
  if (slice.variation === "customImageOnly") {
    return <CustomImageOnly slice={slice} />;
  } else if (
    slice.variation === "customRightImage" ||
    slice.variation === "customLeftImage"
  ) {
    return <CustomImageHorizontal slice={slice} />;
  }
...
const AlternateGridStyled = styled.section`
