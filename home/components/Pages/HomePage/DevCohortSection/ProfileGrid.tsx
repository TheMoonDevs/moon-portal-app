...
const PublicationDialog = ({
  ...
  return (
    <Dialog
      ...
      sx={{ zIndex: 9999, backdropFilter: 'blur(2px)' }}
      PaperProps={{
        sx: {
          width: 'fit-content',
          height: 'fit-content',
    ...
    >
      <CardContainer className="inter-var">
        <CardBody className="group/card group relative h-auto w-auto overflow-hidden rounded-3xl border-2 border-gray-50 bg-black hover:overflow-visible dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] sm:w-[30rem]">
          <CardItem
            translateZ="100"
            className="w-full !overflow-hidden rounded-tl-xl rounded-tr-xl group-hover:rounded-bl-xl group-hover:rounded-br-xl"
          >
            <Image
              src={data?.image_url || ''}
              height="1000"
