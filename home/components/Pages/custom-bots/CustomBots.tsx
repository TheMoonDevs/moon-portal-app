    ...
    <>
      <div className='relative w-full'>
        ...
        <div className='relative z-10 px-12 flex flex-row gap-2 top-16 max-sm:px-4 max-sm:top-0'>
          <ToolTip title='Connect with us on Slack'>
            <img
          ...
          <ToolTip title='Connect with us on Twitter'>
            <img
          ...
          <ToolTip title='Connect with us on Discord'>
            <img
          ...
          <ToolTip title='Message us on WH=hatsapp'>
            <img
          ...
          <ToolTip title='Connect with us on Telegram'>
            <img
        ...
        <div className='relative z-10 flex justify-end '>
          <div className='py-24  px-12 flex flex-col items-start gap-6  max-sm:px-4'>
            ...
            <p className='text-lg'>
              Get InApp Integrations or 3rdParty tool <br /> integrations done
              in a flash & free of cost. <br /> We can do this thanks to our
              large repo trained <br /> AI bots which support hyperspeed coding
              social <br /> bots.
            </p>
          </div>
        </div>
