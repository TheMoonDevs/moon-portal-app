...
const commonTheme = {
  ...
  fixedColors: {
    ...
    tealGreen: "#24ff8a",
    tealGreenText: "#0aff7c",
    tealGreenBackground: "#fafffc",
    white_f:
  ...
  fixedGradients: {
    smokeWhiteBgGradient90: `linear-gradient(90deg, #FFFFFF 0%, rgba(255, 255, 255, 0) 100%), #F1EEEE;`,
    smokeWhiteBgGradient270: `linear-gradient(270deg, #FFFFFF 0%, rgba(255, 255, 255, 0) 100%), #F1EEEE`,
  },
  screens: {
    largeMobile: 480,
    tablet: 768,
