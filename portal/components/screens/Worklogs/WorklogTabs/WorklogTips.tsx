...
const WorklogTips = () => {
  return (
    <div className="p-3">
      ...
      <p className="my-4 text-lg font-bold">Shortcuts</p>
      <ul className="list-disc font-mono text-sm tracking-widest">
        ...
        <li className="">
          Select-Text+Ctrl+B === <strong>Bold Text</strong>
        </li>
        <li className="">
          Select-Text+Ctrl+I === <em>Italic Text</em>
        </li>
        <li className="">
          Select-Text+Ctrl+U === <u>Underline Text</u>
        </li>
