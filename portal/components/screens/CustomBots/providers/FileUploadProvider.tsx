...
interface FileUploadContextType {
    ...
    handleFileChange: (files: FileList, userId: string, folderName: string) => Promise<void>;
...
export function FileUploadProvider({ children }: { children: ReactNode }) {
    ...
    const [mediaUploadStatus, setMediaUploadStatus] = useState<'IDLE' | 'UPLOADING' | 'SUCCESS' | 'ERROR'>('IDLE');

    const handleFileChange = async (files: FileList, userId: string, folderName: string) => {
