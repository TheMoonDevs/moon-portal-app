...
interface WorksheetStore {
  ...
  updateUIState: (
    worksheetId: string,
    updates: Partial<WorksheetUIState>,
  ) => void;
  setCellStyles: (
    worksheetId: string,
    rowId: string,
  ...
  bulkSetCellStyles: (
    worksheetId: string,
    updates: { rowId: string; field: string }[],
    style: Partial<CellStyle>,
  ) => void;
  setRowStyles: (
    worksheetId: string,
...
export const useWorksheetStore = create<WorksheetStore>()(
  persist(
    (set) => ({
      ...
      updateUIState: (worksheetId, updates) =>
        set((state) => ({
          uiStateByWorksheet: {
      ...
      setCellStyles: (worksheetId, rowId, field, style) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      bulkSetCellStyles: (worksheetId, updates, style) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      setRowStyles: (worksheetId, rowId, style) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
          return {
      ...
      bulkSetRowStyles: (worksheetId, rowIds, style) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      setRowHeight: (worksheetId, rowId, height) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
          return {
      ...
      bulkSetRowHeights: (worksheetId, rowIds, height) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      togglePinnedRow: (worksheetId, rowId) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      togglePinnedCol: (worksheetId, field) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      bulkTogglePinnedCols: (worksheetId, fields, pin) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      toggleHiddenRow: (worksheetId, rowId) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      toggleHiddenCol: (worksheetId, field) =>
        set((state) => {
          const wsState =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
      ...
      setServerUIState: (worksheetId, serverState) =>
        set((state) => {
          const existing =
            state.uiStateByWorksheet[worksheetId] || defaultUIState;
          const merged: WorksheetUIState = {
            ...
            ...(serverState && typeof serverState === 'object'
              ? serverState
              : {}),
            pinnedCols: Array.isArray(serverState?.pinnedCols)
              ? serverState.pinnedCols
              : existing.pinnedCols,
            hiddenCols: Array.isArray(serverState?.hiddenCols)
              ? serverState.hiddenCols
              : existing.hiddenCols,
            hiddenRows: Array.isArray(serverState?.hiddenRows)
              ? serverState.hiddenRows
              : existing.hiddenRows,
          };
          return {
            uiStateByWorksheet: {
