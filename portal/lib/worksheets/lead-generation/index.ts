  ...
  schema: defineWorksheet({
    ...
    fields: (f) => ({
      ...
      currency_code: f
        ...
        .optional()
        .googleForm({ questionTitle: "Currency Code", questionType: "dropdown" })
        .ui({ width: 140 }),
      preferred_cities: f
        .asyncSelect()
        .optional()
        .optionsType("preferred_cities")
        .googleForm({ questionTitle: "Preferred Cities", questionType: "dropdown" })
        .ui({ width: 220 }),
    ...
    columns: (c) => [
      ...
      c.computed()
        .pipeline("lead.score.toNumber", "lead.score.toBand", "lead.score.toLabel")
